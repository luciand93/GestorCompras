    ...
    return (
      <div className="min-h-screen bg-[#09090b] text-white flex items-center justify-center">
        <div className="flex flex-col items-center gap-3">
          <span className="material-symbols-outlined text-4xl text-[#10b981] animate-pulse">
            store
          </span>
          <p className="text-[#a1a1aa]">Cargando supermercados...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-[#09090b] text-white pb-24">
        <header className="sticky top-0 z-10 bg-[#09090b]/80 ios-blur border-b border-white/10">
          <div className="flex items-center gap-3 p-4 max-w-md mx-auto">
            <button
              ...
              className="p-2 -ml-2 rounded-xl text-[#a1a1aa] hover:bg-white/5 ios-button"
              aria-label="Volver"
            >
              <span className="material-symbols-outlined">arrow_back</span>
            </button>
            <div className="w-10 h-10 rounded-xl bg-[#18181b] border border-[#10b981]/20 flex items-center justify-center text-[#10b981]">
        ...
        <main className="max-w-md mx-auto p-4">
          {productsLoading ? (
            <div className="py-12 flex flex-col items-center gap-3 text-[#a1a1aa]">
            ...
            <div className="rounded-xl bg-[#18181b] border border-[#10b981]/20 py-12 px-6 text-center">
              <span className="material-symbols-outlined text-6xl text-[#a1a1aa]/30 mb-4">
                shopping_basket
              </span>
              ...
              <a
                href="/scanner"
                className="mt-6 inline-flex items-center gap-2 bg-[#10b981] text-[#09090b] font-bold py-3 px-6 rounded-xl ios-button"
              >
            ...
            <ul className="space-y-2">
              {products.map((p) => (
                <li
                  key={p.product_id}
                  className="flex items-center justify-between gap-4 rounded-xl bg-[#18181b] border border-[#10b981]/20 px-4 py-3"
                >
            ...
            {supermarkets.map((name) => (
              <li key={name}>
                <button
                  ...
                  className="w-full flex items-center gap-4 rounded-xl bg-[#18181b] border border-[#10b981]/20 px-4 py-4 text-left ios-button hover:border-[#10b981]/40 transition-colors"
                >
                  <div className="w-12 h-12 rounded-xl bg-[#234829] flex items-center justify-center text-[#10b981] flex-shrink-0">
                  ...
                  <span className="material-symbols-outlined text-[#a1a1aa]/60 flex-shrink-0">
                    chevron_right
                  </span>
                </button>
              </li>
